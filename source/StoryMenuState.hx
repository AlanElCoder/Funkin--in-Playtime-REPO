...
class StoryMenuState extends MusicBeatState
{
	...
	override function update(elapsed:Float):Void
	{
		...
		/*
		menuItems.members[0].x = FlxMath.lerp(1, menuItems.members[0].x 0.85); //Camera Zoom Lerp
		menuItems.members[0].y = FlxMath.lerp(1, menuItems.members[0].y 0.85); //Camera Zoom Lerp
