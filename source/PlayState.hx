...
class PlayState extends MusicBeatState
{
	...
	var chromO:ChromaticAberrationEffect;
	...
	override public function create()
	{
		...
		if (isStoryMode)
		{
			detailsText = "Story Mode: " +"Chapter " + StoryMenuState.weekJSON.numWeek;
		}
		else
		{
		...
		if(SONG.song=='Remember'){
	        ...
	        blackBG.makeGraphic(1300,1300,FlxColor.BLACK);
	...
	override public function update(elapsed:Float)
	{
		...
		usedPractice = (ClientPrefs.getGameplaySetting('practice', false) || ClientPrefs.getGameplaySetting('botplay', false));
	...
	override function stepHit()
	{
		...
		if (SONG.song=='Remember'){
			switch(curStep){
			   ...
			   case 12:
				    FlxTween.tween(intro,{alpha: 0}, 1.2,{ease:FlxEase.quadInOut,});
